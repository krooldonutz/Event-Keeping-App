...
module.exports = {
    ...
    createEvent: async function (req, res) {
        try {
            ...
            let aEvent = new EventModel({
                ...
                ticketsAvailable: parseInt(input.ticketsAvailable),
    ...
    updateById: async function (req, res) {
        ...
        if (idExists != null && parseInt(req.body.capacity) >= 0) {
            let updateData = {
                name: req.body.name,
            ...
            res.status(400).json("Event Id not Exists");
        }
    },
    ...
    numOfEvent : async function (req, res){
        const counting = await EventModel.countDocuments({});
        res.json(counting);
    }
};
